...
<div class="row" style="margin-top:20px">
    <div class="col-md-6">
        <div class="form" id="createform">
            <div class="form-group">
                <button class="btn btn-danger" id="createtempsimp">生成简易MVC</button>
            </div>
        </div>
    </div>
</div>
<div class="row" style="margin-top:20px">
    ...
    <div class="col-md-12 rescreateinfo">
        <pre><a href="<?=$_siteurl?>/m/manage/navigation?dirpath=<?php echo $value['dirname'];?>" target="_blank" class="btn btn-success btn-xs">添加为目录</a> <button class="btn btn-danger btn-xs deletefile" aid=<?php echo $value['id'];?>>移除文件</button><br><br>创建时间：<?php echo $value['ctime'];?><br><?php

window.onload=function(){
    $("#addUserButton").click(function(){
        ...
        $.ajax({
            url:baseurl+"m/User/ajaxManageRight",
        ...
        function es(){
            ...
            $.ajax({
                url:baseurl+"m/user/ajaxAddUser",
                type:'post',
                data:param,
                success:function(res){
                    if(res.code !=1)
    ...
    $(".delete").on("click",function(){
        ...
        $("#delete .sure").on("click",function(){
            $("#delete").modal("hide");
            $.loadajax({
                url:baseurl+"m/User/deleteUser?id="+id,
                success:function(res)
                {
                    if(res.code == 1)
                    {
    ...
    $(".changepwd").bind("click",function(){
        ...
        $("#changepwdwindow .save").one("click",function(){
            ...
            $.loadajax({
                url:baseurl+"m/User/ajaxAdminCPwd",
                type:"post",
                data:{
                    id:id,
                    pwd:md5(newpwd)
    ...
    $(".changeuserinfo").bind("click",function(){
        ...
        $.loadajax({
            url:baseurl+"m/User/getUserinfo?id="+id,
            success:function(res){
                if(res.code!=1)
                {
                    alertError(res.msg);
        ...
        function savechange()
        {
            ...
            $cw.modal("hide");
            $.loadajax({
                url:baseurl+"m/User/updatUserinfo",
                type:"post",
                data:param,
                success:function(res)
                {

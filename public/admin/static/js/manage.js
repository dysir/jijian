$(function(){	
	...
	$(".first_menu").click(function(){
		...
		$.ajax({
			url:baseurl+"m/Manage/getMenu?id="+aid,
		...
		function es(){
			...
			var url = "m/Manage/editFirstMenu";
			if(!id)
			{
				url = "m/Manage/addFirstMenu";
			}
			$.ajax({
				url:baseurl+url,
				data:param,
	...
	$(".second_menu").click(function(){
		...
		function es()
		{
			...
			$.ajax({
				url:baseurl+"m/Manage/addsecondmenu",
				data:param,
				success:function(res){
					if(res.code !=1)
					{
		...
		function ed()
		{
			...
			$.ajax({
				url:baseurl+"m/Manage/editSecondMenu",
				data:param,
				success:function(res){
					if(res.code !=1)
					{
	...
	$(".add_action_menu").click(function(){
		...
		function ad()
		{
			...
			$.ajax({
				url:baseurl+"m/Manage/addactionmenu",
				data:param,
				success:function(res){
					if(res.code !=1)
					{
	...
	$(".delete_first_menu").click(function(){
		...
		function de()
		{
			$e.modal("hide");
			$.ajax({
				url:baseurl+"m/Manage/deleteMenu?id="+aid,
				success:function(res)
				{
					if(res.code!=1)
					{
	...
	$(".sort_first_menu").click(function(){
		...
		$.loadajax({
			url:baseurl+"m/Manage/getSortMeun?parent="+parent,
			success:function(res){
				if(res.code !=1)
				{
					alertError(res.msg);
				...
				$("#sort_menu .save").one("click",function(){
					...
					$.loadajax({
						url:baseurl+"m/Manage/updateSortMeun",
						data:{
							'sortarr':sortarr
						},
						type:"post",
